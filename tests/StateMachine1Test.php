...
class StateMachine1Test extends TestCase
{
    ...
    public function canProvider()
    {
        return [
            ...
            ['red', 'to_yellow', true],
            ['red', 'to_red', false],
            ['red', 'to_pre_red', false],
            ['yellow', 'to_pre_red', false],
            ['green', 'to_pre_red', true],
            ['pre_red', 'to_pre_red', false],
            ['pre_red', 'to_green', false],
            ['pre_red', 'to_red', true],
            ['red', 'foobar', false],
        ];
    }
    ...
    public function applyProvider()
    {
        return [
            ...
            ['yellow', 'red', \InvalidArgumentException::class],
